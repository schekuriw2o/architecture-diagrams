# Installation
- Install c4builder by using ```npm i -g c4builder```
- Run ```c4builder ``` to compile puml to svg, pdf and web files.
- Run ```c4builder site``` to launch the web files at port 4000.
#Architecture

- Organize the puml files in separate folders to make use of the sidebar and navigation.
- It is recommended to create a readme(.md) file for each .puml file
